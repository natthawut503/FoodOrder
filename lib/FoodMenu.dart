...
List<FoodMenu> foodMenuList = [
  ...
  FoodMenu(name: "Hamburger", price: 100, ingredients: ["Meat", "Bread", "Tomato","Cheese","Lettuce"]),
  FoodMenu(name: "Frenchfries Cheese", price: 100, ingredients: ["Frenchfries", "Cheese"]),
];